...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React49.useState(true);
  const hasPendingExitTransition = React49.useRef(false);
  const registeredTransitions = React49.useRef(0);
  const [hasTransition, setHasTransition] = React49.useState(false);
  const previousRequestEnter = React49.useRef(requestEnter);
  React49.useEffect(() => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5B66FOK4.js.map
