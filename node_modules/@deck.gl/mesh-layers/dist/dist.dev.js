...
`;
  ...
  var VERSION3 = true ? "3.4.2" : "latest";
  ...
  function isImageFormatSupported(mimeType) {
    if (mimeTypeSupportedSync[mimeType] === void 0) {
      const supported = isBrowser4 ? checkBrowserImageFormatSupport(mimeType) : checkNodeImageFormatSupport(mimeType);
