...
declare const TooltipController: React.ForwardRefExoticComponent<ITooltipController & React.RefAttributes<TooltipRefProps>>;
 ...
 * See https://react-tooltip.com/docs/getting-started
 */
declare const TooltipWrapper: ({ tooltipId, children, className, place, content, html, variant, offset, wrapper, events, positionStrategy, delayShow, delayHide, }: ITooltipWrapper) => React.JSX.Element;
